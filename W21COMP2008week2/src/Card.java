...
public class Card {
    ...
    /**
     * This is the constructor that takes 2 arguments, one for the face name and one for the suit. The value of the card
     * assumes that ace are high, and will dynamically establish the card value.
    ...
    public int getFaceValue(){
        //the first face name in the list(position 0) is "two". So we add 2
